...
const chatWithEnhancedHealthBot = async (req, res) => {
  try {
    ...
    try {
      ...
      if (sched?.isSchedule) {
        // Ensure any active creation flow is cleared so schedule routing isn't hijacked
...
// handleCheckMedicineSchedule is now imported from health-bot.controller.js
